        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <div className="flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8">
            ...
            <form className="flex flex-col gap-y-4">
              <input
                className="border border-gray-300 focus:border-violet-700 outline-none rounded w-full p-4 h-14 text-sm"
                type="text"
                placeholder="Name*"
              />
              <input
              ...
              <div className="flex gap-x-2">
                <button className="bg-violet-700 hover:bg-violet-800 transition text-white rounded p-4 text-sm w-full ">Send message</button>
                <button className="border border-violet-700 text-violet-700 hover:border-b-violet-500 hover:text-violet-500 transition rounded p-4 text-sm w-full">Call</button>
              </div>
            </form>
          </div>
        </div>
